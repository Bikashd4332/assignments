<?php
class UserDetails {
    public function __construct($firstName, $lastName, $email, $primaryCellPhone, $secondaryCellPhone, $permanentAddress, $permanentState, $permanentAddressZipCode, $permanentCountry, $currentAddress, $currentState, $currentAddressZipCode, $currentCountry, $isSubscribed, $gender) {
...
$secondaryCellPhone = $_POST['secondaryCellPhone'];    
...
$registeredUser = new UserDetails(
    $firstName, 
    $lastName, 
    $email, 
    $password, 
